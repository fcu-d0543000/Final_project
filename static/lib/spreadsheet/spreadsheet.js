...
var Spreadsheet = /** @class */ (function (_super) {
    ...
    Spreadsheet.prototype.load = function (url, type) {
        ...
        return proxy.load().then(function (data) {console.log(typeof(data)); _this.parse(data, type); });
    };
...
var CustomCsvDriver = /** @class */ (function (_super) {
    ...
    CustomCsvDriver.prototype.toJsonArray = function (data) {
        ...
        // a0981231998@gmail.com
        var limit = (typeof maxIdx !== 'undefined'? maxIdx: dataArr.length);
        var d = dataArr.slice(0, limit).reduce(function (total, item, i) {
                for (var key in item) {
                    total.push({
                        value: item[key],
